...
This document provides guidelines for internationalization of the Thought Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `thought_en.ts` remains unchanged.
