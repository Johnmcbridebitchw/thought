...
This mechanism has been integrated into Bitcore-Node-Thought which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/thoughtnetwork/insight-api-thought#web-socket-api](https://github.com/thoughtnetwork/insight-api-thought#web-socket-api)
* API: [https://github.com/thoughtnetwork/insight-api-thought#instantsend-transactions](https://github.com/thoughtnetwork/insight-api-thought#instantsend-transactions)
