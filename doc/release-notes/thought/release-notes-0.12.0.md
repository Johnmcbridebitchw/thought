...
Thought Core version 0.12.0 is now available from:
...
backwards-compatible with pre-0.12 versions of Thought Core or other software:
...
Switched to Thought Core version 0.10 - https://thought.org/en/release/v0.10.0
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/thought/).
