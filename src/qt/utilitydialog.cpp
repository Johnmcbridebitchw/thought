    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  thought-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        std::string strUsage = HelpMessage(HMM_THOUGHT_QT);
        ...
        if (showDebug) {
            strUsage += HelpMessageOpt("-uiplatform", strprintf("Select platform to customize UI for (one of windows, macosx, other; default: %s)", ThoughtGUI::DEFAULT_UIPLATFORM));
        }
...
All the Thought in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
QWidget *ShutdownWindow::showShutdownWindow(ThoughtGUI *window)
{
    if (!window)
        return nullptr;
