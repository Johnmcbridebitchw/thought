...
# Copyright 2016 The Thought Core developers
...
help_text="""Test framework for thought utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/thought-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "thought-util-test.json", buildenv)
