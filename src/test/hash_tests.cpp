// Copyright (c) 2013-2015 The Thought Core developers
...
#define T(expected, seed, data) BOOST_CHECK_EQUAL(MurmurHash3(seed, ParseHex(data)), expected)
    ...
    // but is useful for those trying to implement Thought libraries as a
...
BOOST_AUTO_TEST_CASE(siphash)
{
    ...
    // TODO reenable when backporting Thought #10321
