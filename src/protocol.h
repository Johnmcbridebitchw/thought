...
/**
 * Thought protocol message types. When adding new message types, don't forget
 ...
 * @see https://thought.org/en/developer-reference#version
 */
extern const char *VERSION;
/**
 * The verack message acknowledges a previously-received version message,
 * informing the connecting node that it can begin to send other messages.
 * @see https://thought.org/en/developer-reference#verack
 */
extern const char *VERACK;
/**
 * The addr (IP address) message relays connection information for peers on the
 * network.
 * @see https://thought.org/en/developer-reference#addr
 */
extern const char *ADDR;
/**
 * The inv message (inventory message) transmits one or more inventories of
 * objects known to the transmitting peer.
 * @see https://thought.org/en/developer-reference#inv
 */
extern const char *INV;
/**
 * The getdata message requests one or more data objects from another node.
 * @see https://thought.org/en/developer-reference#getdata
 */
 ...
 * @see https://thought.org/en/developer-reference#merkleblock
 */
extern const char *MERKLEBLOCK;
/**
 * The getblocks message requests an inv message that provides block header
 * hashes starting from a particular point in the block chain.
 * @see https://thought.org/en/developer-reference#getblocks
 */
 ...
 * @see https://thought.org/en/developer-reference#getheaders
 */
extern const char *GETHEADERS;
/**
 * The tx message transmits a single transaction.
 * @see https://thought.org/en/developer-reference#tx
 */
 ...
 * @since protocol version 31800.
 * @see https://thought.org/en/developer-reference#headers
 */
extern const char *HEADERS;
/**
 * The block message transmits a single serialized block.
 * @see https://thought.org/en/developer-reference#block
 */
extern const char *BLOCK;
/**
 * The getaddr message requests an addr message from the receiving node,
 * preferably one with lots of IP addresses of other receiving nodes.
 * @see https://thought.org/en/developer-reference#getaddr
 */
 ...
 * @see https://thought.org/en/developer-reference#mempool
 */
extern const char *MEMPOOL;
/**
 * The ping message is sent periodically to help confirm that the receiving
 * peer is still connected.
 * @see https://thought.org/en/developer-reference#ping
 */
 ...
 * @see https://thought.org/en/developer-reference#pong
 */
 ...
 * @see https://thought.org/en/developer-reference#alert
 */
 ...
 * @see https://thought.org/en/developer-reference#notfound
 */
 ...
 * @see https://thought.org/en/developer-reference#filterload
 */
 ...
 *   Only available with service bit NODE_BLOOM since protocol version
 *   70011 as described by BIP111.
 * @see https://thought.org/en/developer-reference#filteradd
 */
 ...
 *   Only available with service bit NODE_BLOOM since protocol version
 *   70011 as described by BIP111.
 * @see https://thought.org/en/developer-reference#filterclear
 */
 ...
 * @see https://thought.org/en/developer-reference#reject
 */
 ...
 * @see https://thought.org/en/developer-reference#sendheaders
 */
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Thought Core nodes, and is unset by SPV clients or other peers that just want
    // network services but don't provide them.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // Thought Core does not support this but a patch set called Thought XT does.
    ...
    // thought-development mailing list. Remember that service bits are just
