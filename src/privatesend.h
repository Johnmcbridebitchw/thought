...
/* dash static const int MIN_PRIVATESEND_PEER_PROTO_VERSION = 70213;*/
static const int MIN_PRIVATESEND_PEER_PROTO_VERSION = 70016;
...
public:
    ...
    /// Get the denominations for a specific amount of thought.
