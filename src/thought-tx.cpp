...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s thought-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  thought-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thought transaction") + "\n" +
              "  thought-tx [options] -create [commands]   " + _("Create hex-encoded thought transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CThoughtAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CThoughtAddress redeemScriptAddr(scriptPubKey);
