...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(_("Copyright (C)"), 2014, COPYRIGHT_YEAR) + "\n" +
           ...
           "\n" +
           strprintf(_("This product includes software developed by the OpenSSL Project for use in the OpenSSL Toolkit %s, cryptographic software written by Eric Young, UPnP software written by Thomas Bernard, and MIDAS proof-of-work software written by Ray Dillinger."), "<https://www.openssl.org>") +
           "\n";
}
