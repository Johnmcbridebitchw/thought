...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    std::string debugCategories = "addrman, alert, bench, chainout, cmpctblock, coindb, db, http, leveldb, libevent, lock, mempool, mempoolrej, midas, net, proxy, prune, rand, reindex, rpc, selectcoins, tor, zmq, "
