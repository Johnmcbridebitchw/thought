...
class WalletDumpTest(ThoughtTestFramework):
    ...
    def run_test (self):
        ...
        # TODO clarify if we want the behavior that is tested below in Thought (only when HD seed was generated and not user-provided)
