...
class RawTransactionsTest(ThoughtTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid thought address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid thought address" in e.error['message'])
