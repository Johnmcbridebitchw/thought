...
class WalletTest (ThoughtTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 THT from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 THT in block rewards plus fees, but
        ...
        # Send 100 THT with subtract fee from amount
        ...
        # Sendmany 100 THT with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/thought/thought/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
