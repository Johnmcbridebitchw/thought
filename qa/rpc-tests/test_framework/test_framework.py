...
class ThoughtTestFramework(object):
    ...
    def main(self):
        ...
        if not self.options.noshutdown:
            ...
            print("Note: thoughtds were not stopped and may still be running")
...
# Test framework for doing p2p comparison testing, which sets up some thoughtd
# binaries:
# 1 binary: test binary
# 2 binaries: 1 test binary, 1 ref binary
# n>2 binaries: 1 test binary, n-1 ref binaries

class ComparisonTestFramework(ThoughtTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--testbinary", dest="testbinary",
                          default=os.getenv("THOUGHTD", "thoughtd"),
                          help="thoughtd binary to test")
        parser.add_option("--refbinary", dest="refbinary",
                          default=os.getenv("THOUGHTD", "thoughtd"),
                          help="thoughtd binary to use for reference nodes (if any)")
